              ...
              {isAuthenticated ? (
                <>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center px-4 py-2 rounded-full border border-amber-500/30 bg-stone-950/50 backdrop-blur-sm hover:bg-amber-500/10 hover:border-amber-500/50 transition-all text-amber-200/80 text-sm font-serif"
                  >
                    Leaderboard
                  </Link>
                </>
